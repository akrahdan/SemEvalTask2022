...
import clozetask.management.components.task_sampler as sm_task_sampler
import clozetask.shared.caching as caching
from clozetask.core import Task
from clozetask.retrieval import create_task_from_config_path
...
class TaskContainer:
    ...
    task_sampler: sm_task_sampler.BaseMultiTaskSampler
    ...
    metrics_aggregator: sm_task_sampler.BaseMetricAggregator
...
def create_jiant_task_container(
    ...
    task_sampler = sm_task_sampler.create_task_sampler(
    ...
    metric_aggregator = sm_task_sampler.create_metric_aggregator(
...
def create_jiant_task_container_from_json(
    task_container_config_path: str, verbose: bool = True
) -> TaskContainer:
    return create_jiant_task_container_from_dict(
        jiant_task_container_config_dict=py_io.read_json(task_container_config_path),
        verbose=verbose,
    )