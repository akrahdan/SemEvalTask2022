...
import torch
import clozetask.evaluate as evaluate
import clozetask.utils.torch_utils as torch_utils
from clozetask.management.components.container_setup import TaskContainer
from clozetask.management.modeling.primary import SemEvalModel, wrap_task_forward
from clozetask.shared.constants import PHASE
from clozetask.shared.runner import (
    get_eval_dataloader_from_cache,
    get_train_dataloader_from_cache,
    complex_backpropagate
)
from clozetask.utils.display import maybe_tqdm
from clozetask.utils.datastructures import InfiniteYield, ExtendedDataClassMixin
...
class TaskRunner:
    def __init__(
        ...
        self.jiant_task_container = task_container
        self.jiant_model = model
