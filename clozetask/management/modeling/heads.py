...
@HeadFactory.register([TaskTypes.CLASSIFICATION])
...
@HeadFactory.register([TaskTypes.REGRESSION, TaskTypes.MULTIPLE_CHOICE])
...
@HeadFactory.register([TaskTypes.SQUAD_STYLE_QA])
...
@HeadFactory.register([TaskTypes.MASKED_LANGUAGE_MODELING])
class MLMHeadFactory:
...
@MLMHeadFactory.register([ModelArchitectures.BERT])
...
@MLMHeadFactory.register([ModelArchitectures.ROBERTA, ModelArchitectures.XLM_ROBERTA])
...
@MLMHeadFactory.register([ModelArchitectures.ALBERT])
